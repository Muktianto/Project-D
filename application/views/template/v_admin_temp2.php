...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/css/fontawesome_v5.8.1.css'); ?>">
  <!-- Template CSS -->
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/css/style.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/css/components.css'); ?>">
  <!-- DataTable -->
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/modules/datatables/dataTables.bootstrap4.min.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/modules/datatables/datatables.min.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/modules/datatables/select.bootstrap4.min.css'); ?>">
  <!-- Template CSS -->
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/modules/summernote/dist/summernote-bs4.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/modules/selectric/public/selectric.css'); ?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/modules/prism/prism.css'); ?>"> <!-- modal -->
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/modules/select2/select2.min.css'); ?>">
  <!-- Toast -->  
  <link rel="stylesheet" href="<?php echo base_url('assets/admin/modules/izitoast/iziToast.min.css'); ?>"> 

  <!-- OPTIONAL -->
  <?php 
  if(!empty($ext)){
    if(in_array('advance_input', $ext)){
      echo '<link rel="stylesheet" href="'.base_url('assets/admin/modules/bootstrap-tagsinput/bootstrap-tagsinput.css').'">';
      echo '<link rel="stylesheet" href="'.base_url('assets/admin/modules/bootstrap-timepicker/bootstrap-timepicker.min.css').'">';
      echo '<link rel="stylesheet" href="'.base_url('assets/admin/modules/bootstrap-daterangepicker/daterangepicker.css').'">';
      echo '<link rel="stylesheet" href="'.base_url('assets/admin/modules/bootstrap-colorpicker/bootstrap-colorpicker.min.css').'">';
    }
    if(in_array('ionicon', $ext)){
      echo '<link rel="stylesheet" href="'.base_url('assets/admin/').'">';
      echo '<link rel="stylesheet" href="'.base_url('assets/admin/').'">';
      echo '<link rel="stylesheet" href="'.base_url('assets/admin/').'">';
    }
    ...
    <!-- advance_input -->
    <link rel="stylesheet" href="modules/bootstrap-tagsinput/bootstrap-tagsinput.css">
    <link rel="stylesheet" href="modules/bootstrap-timepicker/bootstrap-timepicker.min.css">
    <link rel="stylesheet" href="modules/bootstrap-daterangepicker/daterangepicker.css">
    <link rel="stylesheet" href="modules/bootstrap-colorpicker/bootstrap-colorpicker.min.css">
    <!-- ionicon -->
    <link rel="stylesheet" href="modules/ionicons/ionicons.min.css">
    <!-- image -->
    <link rel="stylesheet" href="modules/owlcarousel2/dist/owl.theme.default.min.css">
    <link rel="stylesheet" href="modules/owlcarousel2/dist/owl.carousel.min.css">
    ...
    <!-- social -->
    <link rel="stylesheet" href="dules/bootstrap-social/bootstrap-social.css">
    <!-- weather -->
    ...
    <!-- multiupload -->
    <link rel="stylesheet" href="modules/dropzone/dropzone.css">
    <!-- code -->
    <link rel="stylesheet" href="modules/codemirror/codemirror.css">
    <link rel="stylesheet" href="modules/codemirror/duotone-dark.css">
    <!-- calendar -->
...
<body>
  ...
  <!-- General JS Scripts -->
  <script src="<?php echo base_url('assets/admin/modules/jquery-3.3.1.min.js'); ?>"></script>
  ...
  <!-- JS Libraies -->
  <script src="<?php echo base_url('assets/admin/modules/datatables/dataTables.bootstrap4.min.js'); ?>"></script>
  <script src="<?php echo base_url('assets/admin/modules/datatables/datatables.min.js'); ?>"></script>
  <script src="<?php echo base_url('assets/admin/modules/datatables/dataTables.select.min.js'); ?>"></script>
