...
<head>
    ...
    <!-- favicon -->
    <!-- <link href="../../assets/blog/img/favicon.png" rel=icon> -->
    ...
    <!-- font-awesome -->
    <link href="<?php echo base_url('assets/blog/fonts/font-awesome/font-awesome.min.css')?>" rel="stylesheet">
    <!-- Mobile Menu Style -->
    <link href="<?php echo base_url('assets/blog/css/mobile-menu.css')?>" rel="stylesheet">

    <!-- Owl carousel -->
    <link href="<?php echo base_url('assets/blog/css/owl.carousel.css')?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/blog/css/owl.theme.default.min.css')?>" rel="stylesheet">
    <!-- Theme Style -->
...
<!-- jquery Core-->
<script src="<?php echo base_url('assets/blog/js/jquery-2.1.4.min.js')?>"></script>

<!-- Bootstrap -->
<script src="<?php echo base_url('assets/blog/js/bootstrap.min.js')?>"></script>

<!-- Theme Menu -->
<script src="<?php echo base_url('assets/blog/js/mobile-menu.js')?>"></script>
...
<!-- Theme Script -->
<script src="<?php echo base_url('assets/blog/js/script.js')?>"></script>
</body>
</html>